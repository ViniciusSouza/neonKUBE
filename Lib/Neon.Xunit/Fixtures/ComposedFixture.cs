...
namespace Neon.Xunit
{
    ...
    public class ComposedFixture : TestFixture, IEnumerable<KeyValuePair<string, ITestFixture>>
    {
        ...
        private struct SubFixture
        {
            ...
            /// <summary>
            /// Constructor for non-<see cref="KubeServiceFixture{TService}"/> fixtures.
            /// </summary>
            ...
            /// <summary>
            /// Constructor for <see cref="KubeServiceFixture{TService}"/> fixtures.
            /// </summary>
            /// <param name="fixture">The subfixture.</param>
        ...
        /// <see cref="AddServiceFixture{TService}(string, KubeServiceFixture{TService}, Func{TService}, TimeSpan, int)"/> instead.
        /// </note>
        /// </remarks>
            ...
            where TFixture : class, ITestFixture
        {
            ...
            if (fixtureType.IsGenericType && fixtureType.FullName == typeof(KubeServiceFixture<KubeService>).FullName)
            {
        ...
        /// </param>
        /// </param>
        public void AddServiceFixture<TService>(string name, KubeServiceFixture<TService> subFixture, Func<TService> serviceCreator, TimeSpan runningTimeout = default, int group = -1)
