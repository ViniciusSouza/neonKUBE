//-----------------------------------------------------------------------------
// FILE:	    WorkflowQueryException.cs
...
{
    /// <summary>
    /// Thrown when there was a failure to query a workflow.
    /// </summary>
    public class WorkflowQueryException : WorkflowException
    {
        /// <summary>
        /// Constructor.
        /// </summary>
