...
namespace Neon.Temporal
{
    ...
    public class Workflow
    {
        ...
        /// <summary>
        /// Returns the parent <see cref="Temporal.WorkflowBase"/> implementation.
        /// </summary>
        ...
        public async Task ContinueAsNewAsync(params object[] args)
        {
            ...
            // We're going to throw a [TemporalWorkflowRestartException] with the
            // parameters.  This exception will be caught and handled by the 
            // [WorkflowInvoke()] method which will configure the reply such
            // that the temporal-proxy will be able to signal Temporal to continue
        ...
        {
            TemporalHelper.ValidateActivityInterface(typeof(TActivityInterface));
            TemporalHelper.ValidateActivityImplementation(typeof(TActivityImplementation));
            Client.EnsureNotDisposed();
            WorkflowBase.CheckCallContext(allowWorkflow: true);
            SetStackTrace();
