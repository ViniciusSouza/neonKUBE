...
namespace TestTemporal
{
    public partial class Test_RegistrationError
    {
        ...
        public async Task Workflow_DuplicateBlankEntrypoint()
        {
            ...
            await Assert.ThrowsAsync<WorkflowExecutionException>(async() => await worker.RegisterWorkflowAsync<WorkflowDuplicateBlankEntrypoint>());
        }
        ...
        public async Task Workflow_DuplicateEntrypoint()
        {
            ...
            await Assert.ThrowsAsync<WorkflowExecutionException>(async () => await worker.RegisterWorkflowAsync<WorkflowDuplicateEntrypoint>());
        }
        ...
        public async Task Workflow_DuplicateSignal()
        {
            ...
            await Assert.ThrowsAsync<WorkflowExecutionException>(async () => await worker.RegisterWorkflowAsync<WorkflowDuplicateSignal>());
        }
        ...
        public async Task Workflow_DuplicateQuery()
        {
            ...
            await Assert.ThrowsAsync<WorkflowExecutionException>(async () => await worker.RegisterWorkflowAsync<WorkflowDuplicateQuery>());
        }
        ...
        public async Task Workflow_MultipleInterfaces()
        {
            ...
            await Assert.ThrowsAsync<WorkflowExecutionException>(async () => await worker.RegisterWorkflowAsync<WorkflowMultiInterface>());
        }
    }
}
