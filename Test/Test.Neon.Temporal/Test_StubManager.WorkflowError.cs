...
namespace TestTemporal
{
    public partial class Test_StubManager
    {
        ...
        public void Error_WorkflowGenericsNotAllowed()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorGenericWorkflow<int>>(client));
        }
        ...
        public void Error_WorkflowNoEntryPoint()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNoEntryPointWorkflow>(client));
        }
        ...
        public void Error_WorkflowNotInterface()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNotInterfaceWorkflow>(client));
        }
        ...
        public void Error_WorkflowNotPublic()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNotPublicWorkflow>(client));
        }
        ...
        public void Error_WorkflowNonTaskEntryPoint()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNonTaskEntryPointWorkflow1>(client));
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNonTaskEntryPointWorkflow2>(client));
        }
        ...
        public void Error_WorkflowNonTaskSignal()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNonTaskSignalWorkflow>(client));
        }
        ...
        public void Error_WorkflowDuplicateDuplicateDefaultEntryPoints()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IDuplicateDefaultEntryPointsWorkflow>(client));
        }
        ...
        public void Error_WorkflowDuplicateDuplicateEntryPoints()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IDuplicateEntryPointsWorkflow>(client));
        }
        ...
        public void Error_WorkflowDuplicateSignals()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorDuplicateSignalsWorkflow>(client));
        }
        ...
        public void Error_WorkflowNonTaskQuery()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorNonTaskQueryWorkflow>(client));
        }
        ...
        public void Error_WorkflowDuplicateQueries()
        {
            ...
            Assert.Throws<WorkflowExecutionException>(() => StubManager.NewWorkflowStub<IErrorDuplicateQueriesWorkflow>(client));
        }
    }
}
